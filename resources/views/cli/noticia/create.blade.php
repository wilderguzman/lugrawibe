...
<div class="container">
    ...
    {!! Form::open(['url' => 'cli/noticia', 'class' => 'form-horizontal']) !!}

                <div class="form-group {{ $errors->has('docente') ? 'has-error' : ''}}">
                {!! Form::label('docente', 'Docente: ', ['class' => 'col-sm-3 control-label']) !!}
                <div class="col-sm-6">
                    {!! Form::text('docente', Auth::user()->name  , ['class' => 'form-control','readonly' => 'true']) !!}
            ...
            <div class="form-group {{ $errors->has('fecha_inicio') ? 'has-error' : ''}}">
                ...
                <div class="col-sm-6">
                    {!! Form::date('fecha_inicio', $daten, ['class' => 'form-control','readonly' => 'true']) !!}
