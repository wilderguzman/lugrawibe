            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                   ...
                   <li><a href="{{ url('admin/departamento') }}"></i>Departamentos</a></li>
                    ...
                    <li><a href="{{ url('admin/materia', $mate) }}"></i>Planes Globales</a></li>
                    </ol>
...
<div class="col-md-11">
    ...
    <h1>Crear Nuevo Plan Global</h1>
    <hr/>

    {!! Form::open(['url' => 'admin/planglobal', 'class' => 'form-horizontal']) !!}
                ...
                <div class="col-sm-6">
                    {!! Form::text('nombre_plan_global',$materia->nombre_materia, ['class' => 'form-control', 'required' => 'required','readonly' => 'true']) !!}
            ...
            <div class="form-group {{ $errors->has('sigla_plan_global') ? 'has-error' : ''}}">
                ...
                <div class="col-sm-6">
                    {!! Form::text('sigla_plan_global',$materia->sigla_materia , ['class' => 'form-control', 'required' => 'required','readonly' => 'true']) !!}
            ...
            <div class="form-group {{ $errors->has('codigo') ? 'has-error' : ''}}">
                ...
                <div class="col-sm-6">
                    {!! Form::number('codigo',$mate, ['class' => 'form-control','readonly' => 'true', 'required' => 'required']) !!}
