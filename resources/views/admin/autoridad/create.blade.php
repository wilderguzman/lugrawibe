            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                   ...
                   <ol class="breadcrumb">
                    ...
                    <li><a href="#"></i>Crear Autoridad</a></li>
...
<div class="table-responsive">
    ...
    {!! Form::open(['url' => 'admin/autoridad', 'class' => 'form-horizontal']) !!}
            ...
            <div class="form-group {{ $errors->has('codigo') ? 'has-error' : ''}}">
                ...
                <div class="col-sm-6">
                    {!! Form::number('codigo', $variable6, ['class' => 'form-control', 'required' => 'required','readonly' => 'true']) !!}
