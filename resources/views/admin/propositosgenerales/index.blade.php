...
<div class="table-responsive">
    ...
    <h1>Propositos Generales <a href="{{ url('admin/propositosgenerales/create') }}" class="btn btn-primary pull-right btn-sm">Crear Propositos Generales</a></h1>
    <div class="table">
        <table class="table table-bordered table-striped table-hover">
            ...
            <tbody>
            {{-- */$x=0;/* --}}
            @foreach($propositosgenerales as $item)
                {{-- */$x++;/* --}}
                <tr>
                    <td>{{ $x }}</td>
