...
<ul class="Nav1 MainNav1">
    ...
    <li class="MainNav1-Button MainNav1-Button_LeftOfActive"><a href="#">Registro del Plan Global </a></li>
    <li class="MainNav1-Button MainNav1-Button_LeftOfActive"><a href="#">Justificación General</a></li>
    <li class="MainNav1-Button MainNav1-Button_Active"><a href="#">Propositos Generales</a></li>
...
<div class="col-md-11">
    ...
    <h1>Crear Propositos Generales</h1>
    <hr/>

    {!! Form::open(['url' => 'admin/propositosgenerales', 'class' => 'form-horizontal']) !!}
                ...
                <div class="form-group {{ $errors->has('propositos_generales') ? 'has-error' : ''}}">
                {!! Form::label('propositos_generales', 'Propositos Generales: ', ['class' => 'col-sm-3 control-label']) !!}
                <div class="col-sm-6">
                    {!! Form::textarea('propositos_generales', null, ['class' => 'form-control', 'required' => 'required']) !!}
                    {!! $errors->first('propositos_generales', '<p class="help-block">:message</p>') !!}
                </div>
            </div>
