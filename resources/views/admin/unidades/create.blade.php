...
<div class="col-md-11">
    ...
    {!! Form::open(['url' => 'admin/unidades', 'class' => 'form-horizontal']) !!}
            ...
            <div class="form-group {{ $errors->has('duracion_de_la_unidad_en_periodos_academicos') ? 'has-error' : ''}}">
                {!! Form::label('duracion_de_la_unidad_en_periodos_academicos', 'Duracion De La Unidad En Periodos Academicos: ', ['class' => 'col-sm-3 control-label']) !!}
                <div class="col-sm-6">
            ...
            <div class="form-group {{ $errors->has('estado') ? 'has-error' : ''}}">
                {!! Form::label('registra', 'Registrar Otra Unidad: ', ['class' => 'col-sm-3 control-label label-warning ']) !!}
                <div class="col-sm-6">
                                <div class="checkbox">
                <label>{!! Form::radio('registra', '1') !!} Si</label>
            </div>
            <div class="checkbox">
                <label>{!! Form::radio('registra', '0', true) !!} No</label>
            </div>
                    {!! $errors->first('registra', '<p class="help-block">:message</p>') !!}
                </div>
            </div>
