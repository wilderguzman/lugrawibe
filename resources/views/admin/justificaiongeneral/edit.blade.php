...
<div class="col-md-11">
    ...
    <h1>Editar Justificación General</h1>
    <hr/>

    {!! Form::model($justificaiongeneral, [
        'method' => 'PATCH',
        'url' => ['admin/justificaiongeneral', $justificaiongeneral->id],
        'class' => 'form-horizontal'
            ...
            <div class="form-group {{ $errors->has('por_que_se_ensena_y_por_que_esta_dentro_del_plan_de_estudios') ? 'has-error' : ''}}">
                {!! Form::label('por_que_se_ensena_y_por_que_esta_dentro_del_plan_de_estudios', 'Por Que Se Enseña Y Por Que Esta Dentro Del Plan De Estudios: ', ['class' => 'col-sm-3 control-label']) !!}
                <div class="col-sm-6">
            ...
            <div class="form-group {{ $errors->has('en_que_medida_contribuye_a_la_formacion_integral_del_profesional') ? 'has-error' : ''}}">
                {!! Form::label('en_que_medida_contribuye_a_la_formacion_integral_del_profesional', 'En Que Medida Contribuye A La Formación Integral Del Profesional: ', ['class' => 'col-sm-3 control-label']) !!}
                <div class="col-sm-6">
