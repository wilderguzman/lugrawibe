            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                   ...
                   <ol class="breadcrumb">
                    ...
                    <li><a href="{{ url('admin/area', $area) }}"></i>Sub Areas</a></li>
                    <li><a href="#"></i>Crear Sub Areas</a></li>
                    </ol>
...
<div class="table-responsive">
    ...
    <h1>Crear Sub Area de :  {{ $areap->nombre_area }}</h1>
    <hr/>

    {!! Form::open(['url' => 'admin/subarea', 'class' => 'form-horizontal']) !!}


                <div class="form-group {{ $errors->has('area_id') ? 'has-error' : ''}}">
                
                <div class="col-sm-6">
                    {!! Form::hidden('area_id',$area, ['class' => 'form-control' , 'required' => 'required']) !!}
