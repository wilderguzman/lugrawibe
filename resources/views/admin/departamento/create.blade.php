...
<div class="container">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                   ...
                   <ol class="breadcrumb">
                    ...
                    <li><a href="#"></i>Crear Departamento</a></li>
                    </ol>
    ...
    {!! Form::open(['url' => 'admin/departamento', 'class' => 'form-horizontal']) !!}
            ...
            <div class="form-group {{ $errors->has('fecha_creacion') ? 'has-error' : ''}}">
                ...
                <div class="col-sm-6">
                    {!! Form::date('fecha_creacion', $datem, ['class' => 'form-control','readonly' => 'true']) !!}
