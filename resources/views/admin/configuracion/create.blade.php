...
<div class="table-responsive">
    ...
    <h1>Create New Configuracion</h1>
    <hr/>

    {!! Form::open(['url' => 'admin/configuracion', 'class' => 'form-horizontal']) !!}
            ...
            <div class="form-group {{ $errors->has('logo') ? 'has-error' : ''}}">
                ...
                <div class="col-sm-6">
                    {!! Form::select('logo', $image, ['class' => 'form-control']) !!}
            ...
            <div class="form-group {{ $errors->has('facultad') ? 'has-error' : ''}}">
                ...
                <div class="col-sm-6">
                    {!! Form::select('facultad', $image, ['class' => 'form-control']) !!}
            ...
            <div class="form-group {{ $errors->has('organigrama') ? 'has-error' : ''}}">
                ...
                <div class="col-sm-6">
                    {!! Form::select('organigrama', $image, ['class' => 'form-control']) !!}
            ...
            <div class="form-group {{ $errors->has('imgenuno') ? 'has-error' : ''}}">
                ...
                <div class="col-sm-6">
                    {!! Form::select('imgenuno', $image, ['class' => 'form-control']) !!}
            ...
            <div class="form-group {{ $errors->has('imgendos') ? 'has-error' : ''}}">
                ...
                <div class="col-sm-6">
                    {!! Form::select('imgendos',$image, ['class' => 'form-control']) !!}
            ...
            <div class="form-group {{ $errors->has('imgentres') ? 'has-error' : ''}}">
                ...
                <div class="col-sm-6">
                    {!! Form::select('imgentres', $image, ['class' => 'form-control']) !!}
            ...
            <div class="form-group {{ $errors->has('imgencuatro') ? 'has-error' : ''}}">
                ...
                <div class="col-sm-6">
                    {!! Form::select('imgencuatro',$image, ['class' => 'form-control']) !!}
            ...
            <div class="form-group {{ $errors->has('imgencinco') ? 'has-error' : ''}}">
                ...
                <div class="col-sm-6">
                    {!! Form::select('imgencinco', $image, ['class' => 'form-control']) !!}
