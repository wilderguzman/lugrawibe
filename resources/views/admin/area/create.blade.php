...
<div class="table-responsive">
    ...
    {!! Form::open(['url' => 'admin/area', 'class' => 'form-horizontal']) !!}
            ...
            <div class="form-group {{ $errors->has('codigo') ? 'has-error' : ''}}">
                ...
                <div class="col-sm-6">
                    {!! Form::number('codigo', $variable3, ['class' => 'form-control', 'required' => 'required','readonly' => 'true']) !!}
