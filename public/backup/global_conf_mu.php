...
Use this file to configure the LugrawibeBackup multi user mode.
Don't touch this file if you only want to use LugrawibeBackup for one MySQL user.
...
// use $_SESSION['sql_user'] as placeholder for the user name
// sample: $PMBP_MU_CONF['user_conf_file']="../../home/".$PMBP_MU_CONF['user_export_dir']."/LugrawibeBackup_conf.txt";
