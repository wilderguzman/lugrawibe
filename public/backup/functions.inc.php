...
";
   ...
   // }
    ...
    $menu=array_merge($menu,array("backup.php"=>F_BACKUP,"import.php"=>F_IMPORT,"db_info.php"=>F_DB_INFO));
  ///,"scheduled.php"=>F_SCHEDULE
...
<table width=\"".$width."\">
 ...
 <tr>
  ...
  // support links
  echo "<div style=\"position:relative;left:780px;top:-40px\">";
